...
export const COUNTRIES: Country[] = [
  ...
  { code: 'TN', name: 'Tunisia', flag: '🇹🇳' }, { code: 'TR', name: 'Türkiye', flag: '🇹🇷' },
  ...
  { code: 'YE', name: 'Yemen', flag: '🇾🇪' }, { code: 'ZW', name: 'Zimbabwe', flag: '🇿🇼' },
];

export const COUNTRY_MAP = new Map(COUNTRIES.map(c => [c.code, c]));
export const getCountry = (code?: string | null) => (code ? COUNTRY_MAP.get(code) : undefined);
